...
<svg class:transition style="display: block;" viewBox="0 0 380 280">
	...
	<g style="color: hsl(48 95% 76%);">
		<use transform="translate(40 110) scale(1.2) rotate(40)" href="#source-order-almond" />
		<use transform="translate(320 85) scale(0.9) rotate(-35)" href="#source-order-almond" />
		<use transform="translate(310 180) rotate(20)" href="#source-order-almond" />
		<use transform="translate(120 20)" href="#source-order-sparkle" />
		<use transform="translate(320 115) scale(0.9)" href="#source-order-sparkle" />
		<g fill="currentColor">
	...
	<g transform="translate(190 265)">
		<path fill="hsl(15 86% 30%)" d="M -7.5 0 L -7.5 -120 L 7.5 -120 L 7.5 0 L -7.5 0 Z" />
