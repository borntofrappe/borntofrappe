	...
	const handlePiece = ({ x, y }) => {
		if (piece) {
			if (x !== piece.x || y !== piece.y) {
				...
				let j = pieces.findIndex((d) => d.x === piece.x && d.y === piece.y);
		...
		<symbol id="puzzle-puzzle" viewBox="0 0 60 60">
			...
			<g transform="translate(30 42)">
				<g id="puzzle-puzzle-fence">
					...
					>
						<path fill="#80879a" stroke="#80879a" d="M 0 3.5 l 20 0 0 3.5 -20 0z" />
			...
			<g transform="translate(2 15)">
				<g
					...
					stroke-linecap="round"
				>
					<path fill="#c8d0e1" stroke="#c8d0e1" d="M 3 20 l 7 -14 25 0 7 14 0 15 -39 0z" />
					<path fill="#707da0" stroke="#707da0" d="M 0 20 l 10 -20 25 0 -10 20z" />
					<path fill="#4e5c78" stroke="#4e5c78" d="M 35 0 l 10 20 -3 0 -7 -14 -7 14 -3 0z" />
					<path fill="#e8ebf5" stroke="#e8ebf5" d="M 28 26 l 7 -14 7 14 0 9 -14 0z" />
					<path fill="#c8d0e1" stroke="#c8d0e1" d="M 38 35 l 0 -6 a 3 3 0 0 0 -6 0 l 0 6z" />
				</g>
			</g>
