<script>
  ...
  const { Illustration, Shape, TAU } = pkg;
...
<div class="layout">
  {#if mode !== null}
    <div class="controls">
      ...
      <button disabled={r === 0} onclick={handleClear}> Clear </button>
    </div>
  {/if}
  ...
  <svg
    ...
    width="400"
    height="400"
    viewBox="-28.571428571428573 -28.571428571428573 57.142857142857146 57.142857142857146"
  >
    <path
