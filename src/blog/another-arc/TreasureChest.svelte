<script>
	...
	import { Anchor, Shape, Box, TAU } from 'zdog';
	...
	onMount(() => {
		...
		const maroons = ['hsl(8 48% 39%)', 'hsl(10 43% 43%)', 'hsl(10 34% 54%)', 'hsl(12 39% 63%)'];
...
<canvas bind:this={element} style="display: block;" width="400" height="260" />
