...
<div>
  ...
  <svg onanimationend={handleEnd} viewBox="-25 -4 35 22">
    ...
    <defs>
      ...
      <symbol
        id="css-race-rabbit"
        viewBox="-22 -36.438228607177734 39 47.792476654052734"
      >
        <g transform="scale(-1 1)">
          <g
            fill="hsl(0 0% 99%)"
          ...
          >
            ...
            <path
              d="M -6.25 -23 c 1 -5 -1 -8.5 -2.5 -8.5 c -2 0 0 12 2.5 8.5"
            />
          </g>
    ...
    <rect
      fill="url(#css-race-pattern-flag)"
      x="-1.5"
      y="-1.5"
      width="1.5"
      height="3"
