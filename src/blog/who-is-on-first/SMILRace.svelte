...
<div>
  ...
  <svg bind:this={svg} viewBox="-15 -3.5 24 17">
    ...
    <defs>
      ...
      <symbol id="smil-race-chrome" viewBox="-40 -40 80 80">
        <clipPath id="smil-race-chrome-clip">
          ...
          <path
            transform="rotate(30)"
            d="M 0 -20 h 40 v 60 h -20 v -40 a 20 20 0 0 0 -20 -20"
          />
        </clipPath>
      ...
      <symbol id="smil-race-firefox" viewBox="-40 -40 80 80">
        ...
        <linearGradient
          id="smil-race-firefox-gradient-1"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
        ...
        <linearGradient
          id="smil-race-firefox-gradient-2"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
        ...
        <linearGradient
          id="smil-race-firefox-gradient-3"
          x1="0"
          y1="0"
          x2="1"
          y2="1"
    ...
    <rect
      fill="url(#smil-race-pattern-flag)"
      x="-1.5"
      y="-1.5"
      width="1.5"
      height="3"
