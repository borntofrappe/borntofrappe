export default {
	...
	'filter-blur-region': `<svg style="display: block;" viewBox="0 0 2.4 1.3">
    <title>...</title>
    <svg width="1" height="1" viewBox="-50 -50 100 100">
        <defs>
            <filter id="filter-blur-region-blur">
                <feGaussianBlur stdDeviation="2" />
            </filter>
        </defs>
        <g filter="url(#filter-blur-region-blur)">
            <circle fill="hsl(36 99% 65%)" stroke="hsl(228 6% 16%)" stroke-width="3" r="40" />
        </g>
    </svg>
    <g transform="translate(1.25 0.3)">
        <svg width="1" height="1" viewBox="-50 -50 100 100">
            <defs>
                <filter id="filter-blur-region-filter" x="0.35">
                    <feGaussianBlur stdDeviation="2" />
                </filter>
            </defs>
            <g filter="url(#filter-blur-region-filter)">
                <circle fill="hsl(36 99% 65%)" stroke="hsl(228 6% 16%)" stroke-width="3" r="40" />
            </g>
        </svg>
