  ...
  `;
    ...
    class FrameByFrameSVG extends HTMLElement {
      ...
      handlePointerdown(event) {
        ...
        let svg = /** @type { SVGSVGElement | null  }*/ (
          shadowRoot
            .querySelector("slot")
            ?.assignedElements()
        ...
        if (!svg) {
          svg = /** @type {SVGSVGElement} */ (shadowRoot.querySelector("svg"));
        }

        const group = /** @type { SVGGElement }*/ (svg.querySelector("g"));
      ...
      handleSlotchange() {
        ...
        if (svg) {
          ...
          const children = /** @type {SVGPathElement[]} */ ([...svg.children]);
          children.forEach((child, i) => {
            ...
            const orphan = /** @type { SVGPathElement }*/ (
