export default {
	...
	'fe-convolve-matrix': `<svg style="display: block;" viewBox="-2.2 -2.2 4.4 4.4">
    ...
    <g filter="url(#fe-convolve-matrix-filter)" transform="rotate(-5)" stroke-linecap="round" stroke-linejoin="round">
        <g transform="rotate(-5) translate(0 -1.25) rotate(5)">
            <path fill="hsl(0 0% 80%)" stroke="hsl(0 0% 8%)" stroke-width="0.05" d="M 4.898587196589413e-17 -0.8 Q 0.2317627457812106 -0.7132923872213651 0.4702282018339785 -0.647213595499958 T 0.7608452130361228 -0.24721359549995792 0.7608452130361228 0.24721359549995792 0.4702282018339785 0.647213595499958 4.898587196589413e-17 0.8 -0.47022820183397845 0.647213595499958 -0.7608452130361228 0.24721359549995803 -0.7608452130361228 -0.2472135954999582 -0.4702282018339786 -0.6472135954999579 4.898587196589413e-17 -0.8 Z" />
        ...
        <g transform="rotate(85) translate(0 -1.25) rotate(-100)">
            <path fill="hsl(0 0% 80%)" stroke="hsl(0 0% 8%)" stroke-width="0.05" d="M 4.898587196589413e-17 -0.8 Q 0.2317627457812106 -0.7132923872213651 0.4302282018339785 -0.647213595499958 T 0.7608452130361228 -0.24721359549995792 0.7608452130361228 0.24721359549995792 0.4702282018339785 0.647213595499958 4.898587196589413e-17 0.8 -0.47022820183397845 0.647213595499958 -0.7608452130361228 0.24721359549995803 -0.7608452130361228 -0.2472135954999582 -0.4702282018339786 -0.6472135954999579 4.898587196589413e-17 -0.8 Z" />
	...
	'convolve-pixel': `<svg style="display: block;" viewBox="0 0 20.5 6">
    <title>feConvolveMatrix pixel</title>
    <defs>
    ...
    <defs>
        ...
        <filter id="convolve-alpha-1" x="0" y="0" width="1" height="1">
