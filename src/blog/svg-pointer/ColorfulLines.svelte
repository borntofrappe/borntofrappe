<script>
	const colors = ['hsl(172 100% 46%)', 'hsl(261 54% 72%)', 'hsl(10 76% 74%)', 'hsl(67 78% 61%)'];
...
<svg
	...
	on:pointermove={handlePoint}
	on:touchmove|preventDefault
	style="display: block;"
	viewBox="-50 -50 100 100"
>
	<defs>
		<rect id="colorful-lines-background" x="-50" y="-50" width="100" height="100" />
		<path
		...
		<filter id="colorful-lines-filter-brush" x="-0.2" y="-0.2" width="1.4" height="1.4">
			<feTurbulence baseFrequency=".03" numOctaves="3" />
		...
		<mask id="colorful-lines-mask-floor">
			...
			<g filter="url(#colorful-lines-filter)">
				...
				<use fill="none" stroke="black" stroke-width="2" href="#colorful-lines-room" />
			</g>
		</mask>
