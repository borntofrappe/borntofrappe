<script>
  ...
  /** @type  Array<{x: number, dy: number, dur: string, id: string, begin: number, follow: string, fill: string, particles: Particle[]}> */
  ...
  const handleClick = async () => {
    ...
    const animate = /** @type { SVGAnimateElement }*/ (
      svg.querySelector(".firework:last-of-type animate")
    );
...
<div>
  ...
  <button onclick={handleClick}>Fire away</button>
</div>
