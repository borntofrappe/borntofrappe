<script>
  ...
  let offsets = $derived(
    [$time, quadInOut($time), Math.sin($time * Math.PI)].map((d) => d * 50 * -1)
  );
</script>
...
<div>
  ...
  >
    ...
    <svg
      width="1em"
      height="1em"
      viewBox="-11 -5.095012187957764 16 10.190024375915527"
    >
      <g
        fill="none"
        stroke="currentColor"
  ...
  <svg style="display: block;" viewBox="-7.5 -7.5 85 75">
    <symbol id="fish" viewBox="-33.5 -36 74.5 67">
      <defs>
        ...
        <path
          id="fish-fin"
          d="M 0 0 0 12 A 10 10 0 0 0 10 22 L 10 10 A 10 10 0 0 0 0 0 Z"
        />
      </defs>
      <g stroke-linecap="round" stroke-linejoin="round">
        <g stroke-width="2">
          ...
          >
            ...
            <use
              transform="translate(-5 25) scale(-1 1) rotate(90) scale(0.5)"
              href="#fish-fin"
            />
          </g>
          <g
          ...
          >
            <path
              d="M 5 -25 -5 -25 A 25 25 0 0 0 -5 25 L 5 25 A 25 25 0 0 0 5 -25 Z"
            />
            <path
              d="M -30 0 -30 -5 A 2.5 2.5 0 0 0 -30 0 2.5 2.5 0 0 0 -30 5 Z"
            />
          </g>
        </g>
