	...
	>
		...
		<g transform="translate(10 10)">
			...
			<g
				...
				on:keydown={(e) => handleKey({ e, cP: 1 })}
				transform="translate({cP1.x} {cP1.y})"
			>
				<circle fill="#ff0088" stroke="hsl(0 0% 50%)" stroke-width="0.5" r="3.5" />
			</g>
			<g
				style="cursor:pointer;"
				on:pointerdown={() => {
				...
				on:keydown={(e) => handleKey({ e, cP: 2 })}
				transform="translate({cP2.x} {cP2.y})"
			>
				<circle fill="#00aabb" stroke="hsl(0 0% 50%)" stroke-width="0.5" r="3.5" />
			</g>
		</g>
	</svg>
			...
			<svg x="0" y="0" width="2" height="2" viewBox="0 0 150 150">
				...
				<g transform="translate(25 25)">
					...
					<g fill="none" stroke="hsl(0 0% 99%)" stroke-linecap="round">
						...
						<path stroke-width="7" d="M 0 100 C {cP1.x} {cP1.y} {cP2.x} {cP2.y} 100 0" />
					</g>
				</g>
			</svg>
		</g>
