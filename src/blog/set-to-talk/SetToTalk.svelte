  ...
  const options = [
    ...
    option.reduce(
      ...
      },
      {
        delay: 0,
        script:
          /** @type Array<Array<{letter: string, delay: number }>> */ ([]),
      }
    )
  );
</script>
...
>
  ...
  <defs>
    ...
    >
      ...
      <path
        stroke="var(--c1, #985a45)"
        d="M 1 1 h 2 M 9 4 h 3 M 3 8 h 3 M 12 11 h 2 M 7 14 h 3"
      />
    </pattern>
    <pattern
    ...
    >
      ...
      <path
        stroke="var(--c1, #985a45)"
        d="M 0 10 h 16 M 0 11 h 16 M 0 13 h 16"
      />
      <path
    ...
    >
      ...
      <path
        transform="translate(0.5 0.5)"
        stroke="var(--c6, #387cbb)"
        d="M 1 2 v 14 M 2 2 v 14"
      />
      <path
        stroke="var(--c0, #0a0200)"
      ...
      <path
        stroke="var(--c1, #985a45)"
        d="M 11 10 h 5 M 12 11 h 4 M 14 13 h 2"
      />
      <path
        transform="translate(-0.5 -0.5)"
        stroke="var(--c0, #0a0200)"
    ...
    >
      ...
      <path
        stroke="var(--c0, #0a0200)"
        d="M 0 0 h 7 M 1 12 h 1 M 2 11 h 4 M 6 12 h 1"
      />
      <path
        transform="translate(-0.5 -0.5)"
        stroke="var(--c0, #0a0200)"
  ...
  <use
    ...
    href="#set-to-talk-tile-entrance"
  />
  ...
  {#each options as option, i}
    <g>
      <set
        attributeName="display"
        to="none"
        begin="0s; setToTalkPhoneCall.begin"
      />
      <set
        attributeName="display"
        to="initial"
        begin="setToTalkPhoneCall{i}.begin"
      />
