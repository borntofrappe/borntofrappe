    ...
    Array(points)
      ...
      .reduce((acc, curr, i, arr) => {
        ...
        if (i === 0) {
          ...
          const [x0, y0] = arr[0];
          const noise =
            Math.random() > 0.5 ? Math.random() : Math.random() * -1;
    ...
    return {
      ...
      laps: Array(laps)
        ...
        .map((_, j) => {
          ...
          const begin =
            j === 0 ? `indefinite` : `spaceRaceSpaceship${i}Lap${j - 1}.end`;
  ...
  <svg bind:this={svg} viewBox="-80 -60 160 120">
          ...
          <g stroke-linecap="round" stroke-linejoin="round">
            ...
            <g stroke-width="3">
              <g fill="var(--c, #6ca4d5)" stroke="var(--c, #6ca4d5)">
                ...
                <path
                  transform="scale(-1 1)"
                  d="M 12 -10 q 20 10 20 30 -10 -5 -20 -5z"
                />
              </g>
              <g fill="#f3f4f8" stroke="#f3f4f8">
                ...
                <path
                  d="M 0 15 q -6 2 -10 7.5 a 18 18 0 0 0 20 0 q -4 -5.5 -10 -7.5"
                />
              </g>
            </g>
          </g>
    ...
    <g transform="rotate(-20)">
      <g>
        ...
        <use
          opacity="0.7"
          fill="url(#space-race-gradient-light)"
          href="#space-race-body"
        />

        <use
          fill="url(#space-race-gradient-bodies)"
          href="#space-race-bodies"
        />
