...
<p>
	<code
		>d="M 0 0 Q 10 <span style:border-block-end="0.2rem solid {accentColor}">{cy}</span> 20 0 T 40 0"</code
	>
</p>
...
<svg viewBox="-1 -14 42 28">
	...
	<g fill="currentColor">
		<g transform="translate(10 {cy})">
			<circle r="0.7" />
			<text x="1.5" y="0.5" font-weight="700" font-size="2" font-family="monospace">(10, {cy})</text
			>
		</g>
		<circle cx="30" cy={cy * -1} r="0.7" />
	</g>
	<g fill="none" stroke="currentColor" stroke-width="0.2" stroke-dasharray="0.5 1">
		<path
