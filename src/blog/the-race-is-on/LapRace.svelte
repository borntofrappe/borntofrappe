<script>
  ...
  onMount(() => {
    const animateMotion = /** @type { SVGAnimateMotionElement }*/ (
...
<div>
  ...
  <svg bind:this={svg} viewBox="0 0 80 40">
    <defs>
      <symbol id="lap-race-car" viewBox="0 0 100 70">
        <mask id="lap-race-car-mask-cockpit">
          <rect width="100" height="70" fill="white" />
          <path
            d="M 66 0 v 15 a 20 20 0 0 0 0 40 v 15 h 34 v -70z"
            fill="black"
          />
        </mask>
        <mask id="lap-race-car-mask-spoiler">
          <rect width="100" height="70" fill="white" />
        ...
        <g stroke-linecap="round" stroke-linejoin="round">
          <g stroke-width="2">
            ...
            />
            <g mask="url(#lap-race-car-mask-spoiler)">
              <path
                fill="var(--c1, #273665)"
                stroke="var(--c1, #273665)"
                transform="translate(0 15)"
          ...
          <g>
            ...
            />
            <g mask="url(#lap-race-car-mask-cockpit)">
              <path
                fill="var(--c1, #273665)"
                transform="translate(30 35)"
                d="M 0 0 c 0 -15 40 -10 40 0 0 10 -40 15 -40 0"
      ...
      <path
        id="lap-race-track"
        d="M 40 5 h 20 a 15 15 0 0 1 0 30 h -40 a 15 15 0 0 1 0 -30 h 20"
      />
    </defs>
