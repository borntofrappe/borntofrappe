...
<svg class:open style="display: block;" viewBox="-42 -36 84 84">
	<g stroke-linecap="round" stroke-linejoin="round">
		<path fill="hsl(227 42% 51%)" d="M -36 0 A 36 36 0 0 1 36 0" />
		<path fill="hsl(221 78% 86%)" d="M -29 0 A 29 29 0 0 1 29 0" />
		<rect fill="hsl(210 36% 96%)" x="-38" width="76" height="4" rx="2" />
		<rect fill="hsl(221 78% 86%)" x="-35" y="4" width="70" height="40" />
		<rect fill="hsl(227 42% 51%)" x="-36" y="44" width="72" height="4" rx="2" />
		<rect
			fill="hsl(224 67% 76%)"
			stroke="hsl(225 57% 67%)"
			stroke-width="2"
			x="-15"
			y="13"
			width="30"
