...
<div>
	...
	<svg style="display: block;" viewBox="0 0 80 40">
		<svg x="5" y="5" width="10" height="30" viewBox="-5 -15 10 30">
			...
			>
				<text
					...
					y="3.8">1</text
				>
				<text transform="translate(0 {easeInSine(t) * 12}) scale({1 - easeInSine(t) * 0.8})" y="3.8"
					>0</text
				>
			</g>
		</svg>
		...
		<svg x="20" y="5" width="60" height="30" viewBox="-5 -20 60 37">
			<g transform="translate(20 0)" style="color: var(--accent-time, currentColor)">
				<path
			...
			<g fill="currentColor" font-family="monospace" font-weight="700" font-size="4">
				<text y="-6">old</text>
				<text y="10">new</text>

				<text transform="translate(37 -6)" text-anchor="middle" textLength="22">slide-out</text>
				<text transform="translate(37 10)" text-anchor="middle" textLength="22">slide-in</text>
			</g>
		</svg>
	</svg>
</div>
