  ...
  <svg class:pressed viewBox="-45 -45 90 90">
    <defs>
      ...
      <filter id="top-hat-filter">
        ...
        <feColorMatrix
          values="1 0 0 5.5 -1 0 0.5 0 5.5 -1 0 0 0.5 5.5 -1 0 0 0 0 1"
        />
    ...
    <g class="translate">
      <g class="scale">
        ...
        <g
          ...
          font-weight="700"
        >
          <text transform="translate(-9 -13) rotate(-12)" font-size="5"
            >&lt;svg&gt;</text
          >
          <text transform="translate(8 -17) rotate(20)" font-size="6"
            >&lt;object&gt;</text
          >
        </g>
      </g>
    ...
    <path
      fill="hsl(41 9% 35%)"
      d="M -20 0 -14 0 A 14 7 0 0 0 14 0 L 20 0 A 20 11 0 0 1 -20 0"
    />
  </svg>
</button>
