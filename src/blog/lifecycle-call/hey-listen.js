...
if (browser && customElements && !customElements.get('hey-listen')) {
    ...
    <g id="flip">
		...
		attributeChangedCallback(name, oldValue, newValue) {
			...
			if (color) {
				this.shadowRoot.querySelector('svg').style.setProperty('color', color);
			}
		}
		...
		connectedCallback() {
			...
			const flip = shadowRoot.querySelector('svg #flip');
			const rotate = shadowRoot.querySelector('svg #rotate');
			const translate = shadowRoot.querySelector('svg #translate');
			const scale = shadowRoot.querySelector('svg #scale');
			const repeat = shadowRoot.querySelector('svg #animate');
