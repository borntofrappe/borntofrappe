...
<style>
	...
	@media (prefers-color-scheme: dark) {
		:global(html:not([data-preference])) .c1 {
			color: hsl(185, 91%, 17%);
		}
		:global(html:not([data-preference])) .c2 {
			color: hsl(185, 62%, 45%);
		}
		:global(html:not([data-preference])) .c3 {
			color: hsl(185, 94%, 87%);
		}
	}

	:global(html[data-preference='dark']) .c1 {
		color: hsl(185, 91%, 17%);
	}
	:global(html[data-preference='dark']) .c2 {
		color: hsl(185, 62%, 45%);
	}
	:global(html[data-preference='dark']) .c3 {
		color: hsl(185, 94%, 87%);
	}
</style>
