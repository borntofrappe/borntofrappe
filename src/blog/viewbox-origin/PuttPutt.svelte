<script>
  ...
  const handleClick = () => {
    ...
    const animate = /** @type { SVGAnimateElement } */ (
      svg.querySelector("#puttPuttStrike")
    );
...
<div>
  {#if canAnimate}
    <button out:scale onclick={handleClick}>Putt putt!</button>
  {/if}
  ...
  <svg bind:this={svg} viewBox="0 0 36 36">
    <defs>
      ...
      <path
        id="putt-putt-grass-0"
        d="M 0 0 l 1 -2.5 0.75 2.5 l 1.25 -3 1.5 3 l 0.75 -2.5 1 2.5"
      />
    ...
    <g transform="translate(0 28)">
      ...
      <g transform="translate(18 2.5)">
          ...
          <g transform="rotate(0)">
            ...
            <g stroke-width="0.5" stroke-linejoin="round">
              ...
              <path
                fill="#b6cea6"
                stroke="#b6cea6"
                d="M 0 15 l -2.4 0.25 0 2.25 0.4 0 2 -0.5"
              />
              <path
                fill="#a3a1a1"
                stroke="#a3a1a1"
                d="M 0 15 l -2 0.5 0 2 2 -0.5z"
              />
            </g>
        ...
        <g transform="translate(165.5 0.5)">
          ...
          <path
            fill="#40d1a6"
            d="M -2.4 0 c 0 1.2 4.8 1.2 4.8 0 v 40 h -4.8z"
          />
        </g>
      </g>
