<script>
  ...
  const { Illustration, Group, Shape, easeInOut, TAU } = pkg;
...
>
  ...
  <defs>
    <symbol
      id="cosmic-adventure-star-symbol"
      viewBox="-10 -10.3819661140441895 20 20"
    >
    ...
    <symbol id="cosmic-adventure-sparkle-symbol" viewBox="-5 -5 10 10">
      <g fill="currentColor" stroke="none">
        <path
          d="M -5 0 a 5 5 0 0 0 5 -5 5 5 0 0 0 5 5 5 5 0 0 0 -5 5 5 5 0 0 0 -5 -5"
        />
      </g>
    </symbol>
  ...
  <g transform="translate(50 50)">
    <g style="color: hsl(212 33% 89%)">
      ...
      <use
        transform="translate(60 105) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(70 165) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(80 215) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(85 40) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(115 120) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(125 55) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(125 180) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(175 90) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(185 25) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(220 60) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(240 20) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(245 95) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(260 150) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(260 220) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(280 35) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(305 70) scale(0.9)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(305 195) scale(1.25)"
        href="#cosmic-adventure-star"
      />
      <use
        transform="translate(330 125) scale(1.25)"
        href="#cosmic-adventure-star"
      />
