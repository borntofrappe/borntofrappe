<script>
  ...
  let coords = tweened([
    0, 4, 1, 3, 2, 3, 3, 1, 4, 4, 5, 3, 6, 3, 7, 2, 8, 0, 9, 1, 10, 1,
  ]);
  let d = $derived(`M ${$coords.join(" ")} 10 5 0 5`);
...
<div>
  <button onclick={handleClick}>Update points</button>

  <svg viewBox="0 0 12 7.5">
    <defs>
      <linearGradient
        id="line-chart-gradient-shadow"
        x1="0"
        x2="0"
        y1="0"
        y2="1"
