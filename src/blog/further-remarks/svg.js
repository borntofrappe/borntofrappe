export default {
	...
	<defs>
		<symbol id="marker-canvas-circle" viewBox="0 0 2 2">
			<circle fill="hsl(0, 0%, 28%)" cx="1" cy="1" r="1" />
		</symbol>
	</defs>
	...
	<g transform="translate(1 1)">
		...
		<use href="#marker-canvas-circle" width="0.3" height="0.3" />
	</g>
</svg>`,
	...
	<defs>
		<pattern id="markers-pattern-flag" viewBox="0 0 2 2" x="0.125" width="0.5" height="0.5">
		...
		<marker id="markers-marker-start" viewBox="0 0 2 2" refX="1" refY="1" markerWidth="6" markerHeight="6">
			<g transform="translate(1 1)">
