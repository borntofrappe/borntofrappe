export default {
	...
	'console-dom-exception': `<svg style="display: block;" viewBox="0 0 100 37">
    <rect fill="hsl(249 11% 12%)" width="100" height="37" rx="5" />
    ...
    <g font-family="monospace" font-weight="700">
        ...
        <g fill="hsl(0 0% 94%)">
            ...
            <g transform="translate(10 2)" font-size="3.25">
                <text y="29">An invalid or illegal string was specified</text>
            </g>
        </g>
    </g>
    <rect style="pointer-events: none;" fill="url(#console-gradient)" width="100" height="37" rx="5" />
</svg>`
};
