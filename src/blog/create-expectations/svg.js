export default {
	...
	'console-dom-exception': `<svg style="display: block;" viewBox="0 0 100 46">
    ...
    <g font-family="monospace" font-weight="700">
        ...
        <g fill="hsl(0 0% 94%)">
            ...
            <g transform="translate(10 2)" font-size="3.25">
                <text y="29">Failed to construct 'CustomElement'</text>
                <text y="37">The result must not have children</text>
            </g>
        </g>
    </g>
    <rect style="pointer-events: none;" fill="url(#console-gradient)" width="100" height="46" rx="5" />
</svg>`,
	'shadow-dom-fix': `<svg style="display: block;" viewBox="0 0 100 46">
    ...
    <g font-family="monospace" font-weight="700">
        <text fill="hsl(258 97% 74%)" font-size="3.25" x="35" y="9">Console</text>
        <g fill="hsl(0 0% 94%)">
            <text fill="hsl(258 97% 74%)" font-size="3.25" x="10" y="21">// &#x2714; Shadow DOM proofed</text>
            <text font-size="3.5" x="10" y="29"><tspan fill="hsl(195 74% 71%)">document.createElement</tspan>("push-particle");</text>
        </g>
    </g>
