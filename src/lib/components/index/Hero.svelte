	...
	const links = [
		{
			...
			icon: `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="-50 -50 100 100" width="1em" height="1em">
...
<header>
	<div>
		<h1>Hello, world!</h1>
		<p>I enjoy writing code. Let me try and convince you I might be good at it as well.</p>
	</div>
