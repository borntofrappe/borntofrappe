...
<style>
  ...
  section::after {
    animation: tilt-telescope 8s cubic-bezier(0.445, 0.05, 0.55, 0.95) infinite
      alternate;
    animation: tilt-telescope var(--animation-duration) var(--ease-in-out-sine)
      infinite alternate;
