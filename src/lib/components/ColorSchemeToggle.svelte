...
<button bind:this={button} disabled on:click={handleClick}>
								...
								<g class="rotate">
									<g transform="scale(-1 1)">
										<g fill="currentColor" stroke="none">
											<circle r="20" />
											<circle transform="translate(0 40)" r="8" />
											<circle transform="rotate(45) translate(0 40)" r="8" />
											<circle transform="rotate(90) translate(0 40)" r="8" />
											<circle transform="rotate(135) translate(0 40)" r="8" />
											<circle transform="rotate(180) translate(0 40)" r="8" />
											<circle transform="rotate(225) translate(0 40)" r="8" />
											<circle transform="rotate(270) translate(0 40)" r="8" />
											<circle transform="rotate(315) translate(0 40)" r="8" />
										</g>
									</g>
								</g>
							</g>
