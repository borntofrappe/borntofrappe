	...
	<g>
		<g transform="translate(20 25)">
			<g stroke="currentColor" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round">
				<g fill="#2969bd">
					<path id="find-the-butterflies-ribbon-bottom" d="M 0 1 c 0 2 1 8 2 9 1 -2 3 -1 3 -2z" />
					<use transform="scale(-1 1)" href="#find-the-butterflies-ribbon-bottom" />
					<path id="find-the-butterflies-ribbon-top" d="M 0 0 c 0 -4 10 -8 6 1 3 6 -6 6 -6 -1" />
					<use transform="scale(-1 1)" href="#find-the-butterflies-ribbon-top" />
				</g>
				<g fill="none">
					<path id="find-the-butterflies-ribbon-inset" d="M 0 0.25 c 1 -2 5 -2 3.8 0" />
			...
			<g stroke="currentColor" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round">
				<g fill="#2969bd">
					<g id="find-the-butterflies-butterfly-wing">
						...
						<path
							...
							d="M 0 3 c 0 -5 11.5 -9 5 1 3 6 -4 8 -5 -1"
						/>
					</g>
				...
				<g fill="none">
					<path
						...
						transform="translate(0.5 -1) rotate(-40)"
				...
				<g fill="none">
					<path
						...
						transform="translate(1.25 -0.5) rotate(-40)"
