...
<svg
	...
	aria-label={isAnimated
		...
		: 'Slide the tiles so that the colors are in the correct order. Focus on a tile and press enter or one of the possible arrow keys to move the piece.'}
>
	<defs>
