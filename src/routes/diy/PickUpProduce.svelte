...
<svg style="display: block;" viewBox="0 0 80 50">
  ...
  <defs>
    ...
    <symbol id="pick-up-produce-crop" viewBox="-15 -21 30 47">
      ...
      >
        <path
          transform="rotate(0) translate(0 21)"
          d="M 0 0 a 1 1 0 0 0 0 2 1 1 0 0 1 0 2"
        />
        <path
          transform="rotate(15) translate(0 20.5)"
          d="M 0 0 a 1 1 0 0 0 0 2 1 1 0 0 1 0 2"
        />
        <path
          transform="rotate(-15) translate(0 20.5)"
        ...
        />
        <path
          transform="rotate(-30) translate(0 20)"
          d="M 0 0 a 1 1 0 0 0 0 2 1 1 0 0 1 0 2"
        />
        <path
          transform="rotate(30) translate(0 20)"
      ...
      <g stroke="#c64e00" stroke-linecap="round" stroke-linejoin="round">
        <g fill="#c64e00">
          <path
            transform="translate(3.25 9)"
            d="M 0 0 l 1.1 1.7 -1.1 1.7 -1.1 -1.7z"
          />
          <path
            transform="translate(-3.25 9)"
            d="M 0 0 l 1.1 1.7 -1.1 1.7 -1.1 -1.7z"
      ...
      <path
        fill="#ffdd9d"
        d="M -1.5 -1 h 3 v 4 l -0.75 -0.75 -0.75 0.75 -0.75 -0.75 -0.75 0.75z"
      />
      <path
        opacity="0.1"
        d="M -1.5 -1 h 3 v 4 l -0.75 -0.75 -0.75 0.75 -0.75 -0.75 -0.75 0.75z"
      ...
      <g stroke="#12984f" stroke-linecap="round" stroke-linejoin="round">
        <path
          fill="none"
          stroke-width="1.25"
          d="M 2 -6 v 11 a 13 8 0 1 1 -4 0 v -11"
        />
    ...
    <symbol id="pick-up-produce-crop-top-0" viewBox="-15 -21 30 47">
      <g transform="translate(0 -6)">
        ...
        >
          <path
            stroke-width="1.25"
            d="M 3 -4 c 2 -5 -1 -9 -3 -10 c -2 1 -5 5 -3 10"
          />
          ...
          <g stroke-width="0.75">
            ...
            <path
              transform="scale(-1 1)"
              d="M 2.5 -2.75 c 2 -2 4 -6 4.25 -7.5"
            />
          </g>
        </g>
      </g>
    ...
    <symbol id="pick-up-produce-crop-top-1" viewBox="-15 -21 30 47">
      <g transform="translate(0 -6)">
        ...
        >
          <path
            stroke-width="1.25"
            d="M 2 -4 c 2 -2 0 -10 -8 -10 c 0 8 6 5 4 10"
          />
          ...
          <g stroke-width="0.75">
            ...
            <path
              transform="scale(-1 1)"
              d="M 1.75 -3.5 c 2 -1 2 -4.25 5 -4.5"
            />
          </g>
        </g>
      </g>
    ...
    <symbol id="pick-up-produce-crop-top-2" viewBox="-15 -21 30 47">
      <g transform="translate(0 -6)">
        ...
        >
          <path
            stroke-width="1.25"
            d="M 2 -4 c 2 -2 0 -10 -8 -9 c 0 5 5 4 4 9"
          />
          ...
          <g stroke-width="0.75">
            ...
            <path
              transform="scale(-1 1)"
              d="M 2 -3.5 c 1.75 -1 2 -3 4.5 -3.5"
            />
          </g>
        </g>
      </g>
    ...
    <symbol id="pick-up-produce-crop-top-spoiled" viewBox="-15 -21 30 47">
      <g transform="translate(0 -6)">
        ...
        >
          <path
            stroke-width="1.25"
            d="M 2 -4.5 c 1 -1 0 -7 -6 -7 c 1 2 2 4 2 7"
          />
      ...
      <g transform="translate({x} 0)">
        <g style="cursor: pointer">
          ...
          <g transform="translate({from})">
            ...
            <use
              opacity="0"
              href="#pick-up-produce-crop-top-0"
              width={w}
              height={h}
            />
          </g>
