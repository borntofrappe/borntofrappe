<script>
  ...
  const script = [
    ...
    const initial =
      i === 0 ? `${start}.begin` : `battleTheEnemyHit${i - 1}.end`;
...
<svg style="display: block;" viewBox="0 0 80 50">
  ...
  <g stroke-linecap="round" stroke-linejoin="round">
    <g fill="#f1f6f6" stroke="#f1f6f6">
      <path
        stroke-width="3"
        d="M 4 4 c 7 -1 6 3 10.5 5.5 c -3 1 -7 1 -11.5 0 c 3 -1 3 -4 1 -5.5"
      />
      <path
        stroke-width="2"
      ...
      <path
        stroke-width="2"
        d="M 66 10 c 3 5 15 -1 9 -6.5 c 0 4 -4 4 -4 4 c -2 0 -2 2.5 -5 2.5"
      />
    </g>
