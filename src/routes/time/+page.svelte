<script>
  ...
  let hands = $derived.by(() => {
    const minutes = time.getMinutes();
    return {
      hours: (time.getHours() % 12) * 30 + minutes * 0.5,
      minutes: minutes * 6,
    };
  });
...
<svelte:head>
  <title>{datetime} | {site.title}</title>
  <meta
    name="description"
...
<div>
  ...
  <svg viewBox="-150 -150 300 300">
    ...
    <g style="color: hsl(43 13% 90%);">
      ...
      <use
        href="#almond"
        transform="translate(60 -115) scale(1.4) rotate(-40)"
      />
    </g>
    ...
    <g fill="hsl(41 8% 48%)">
      <path
        ...
        d="M -4 -11 -4 -30 A 4 4 0 0 1 4 -30 L 4 -11"
      />
      <path
