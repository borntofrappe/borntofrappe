...
<svg style="display: block;" viewBox="{x} {y} {width} {height}">
	<defs>
		<pattern id="ease-pattern" viewBox="-0.1 -0.1 100.2 100.2" width="0.25" height="0.25">
			<rect fill="none" stroke="hsl(0 0% 71%)" stroke-width="0.2" width="100" height="100" />
		</pattern>
	...
	<rect fill="none" stroke="hsl(0 0% 71%)" stroke-width="0.05" width={size} height={size} />
