export default {
    ...
    <svg style="color: hsl(0 0% 75%)" x="-0.1" y="-0.125" width="0.2" height="0.2" viewBox="-21.832719802856445 -25.32887840270996 46.746585845947266 46.746585845947266">
	...
	'pointer-events-threshold': `<svg style="display: block;" viewBox="-0.2 -0.2 2.5 1.4">
    <style>
    .pointer-events-threshold {
        opacity: 0;
        transition: opacity 0.2s cubic-bezier(0.37, 0, 0.63, 1);
    }
    .pointer-events-threshold:hover {
        opacity: 1;
    }
    </style>
    <path fill="hsl(0 0% 14%)" d="M -0.2 0.3 C -0.2 -0.2 -0.2 -0.2 0.3 -0.2 L 1.8 -0.2 C 2.3 -0.2 2.3 -0.2 2.3 0.3 L 2.3 0.7 C 2.3 1.2 2.3 1.2 1.8 1.2 L 0.3 1.2 C -0.2 1.2 -0.2 1.2 -0.2 0.7" />
    ...
    <svg width="1" height="1" viewBox="-70 -70 140 140">
        <circle class="pointer-events-threshold" style="pointer-events: auto;" fill="hsl(0 0% 45%)" r="40" />
        <path style="pointer-events: none;" fill="none" stroke="hsl(0 0% 95%)" stroke-dasharray="0.01 0.03" pathLength="1" d="M 0 -40 A 40 40 0 0 1 0 40 40 40 0 0 1 0 -40" />
        <text fill="hsl(0 0% 95%)" font-family="monospace" font-weight="700" font-size="12" text-anchor="middle" y="68">auto</text>
    </svg>
    <svg x="1.1" width="1" height="1" viewBox="-70 -70 140 140">
        <circle class="pointer-events-threshold" style="pointer-events: bounding-box;" fill="hsl(0 0% 45%)" r="40" />
        <path style="pointer-events: none;" fill="none" stroke="hsl(0 0% 95%)" stroke-dasharray="0.01 0.03" pathLength="1" d="M -40 -40 40 -40 40 40 -40 40 Z" />
        <text fill="hsl(0 0% 95%)" font-family="monospace" font-weight="700" font-size="12" text-anchor="middle" y="68">bounding-box</text>
    </svg>
</svg>`
};
