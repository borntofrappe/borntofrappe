<script>
	let time = 0;
	$: scale = 1 + time;
	$: transformScale = 1 - time / 2;
	$: size = scale * transformScale;
</script>
...
<div>
	...
	<svg style="display: block;" viewBox="-0.2 -0.2 2.75 2.5">
		...
		>
			...
			<text font-size="0.125" font-weight="700" transform="translate(2.1 1.035)" y={1 - size}>
				{size.toFixed(3)}
			</text>
		</g>

		<g transform="translate(0 2) scale(1 -1)">
			<path fill="none" stroke="currentColor" stroke-width="0.01" d="M {time * 2} {size} H 2" />
