...
<svg bind:this={element} class:animate style="display: block;" viewBox="-235 -73 470 172">
	...
	<use pointer-events="none" class="fade" style="color: hsl(44 93% 57%);" href="#message-text" />
</svg>
