<script>
	...
	import { Anchor, Shape, Ellipse, easeInOut, TAU } from 'zdog';
	...
	onMount(() => {
		...
		const animate = () => {
			...
			easeBack.rotate.z = backInOut(ticker / cycle, 3) * TAU;
...
<div bind:this={div}>
	<svg aria-hidden="true" style="position: absolute; inline-size: 0; block-size: 0;">
