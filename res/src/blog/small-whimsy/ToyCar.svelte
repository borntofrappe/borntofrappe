<script>
	...
	import { Anchor, Group, Shape, Box, Ellipse, RoundedRect, TAU, easeInOut } from 'zdog';
...
<style>
	...
	button {
		...
		background: linear-gradient(to right, hsl(177 100% 96%), hsl(177 100% 96%)) padding-box,
			linear-gradient(var(--angle, 0deg), hsl(340 100% 90%), hsl(348 100% 84%)) border-box;
