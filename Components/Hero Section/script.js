...
codepen: `<svg aria-hidden="true" aria-focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="-50 -50 100 100" width="1em" height="1em">
...
freecodecamp: `<svg aria-hidden="true" aria-focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="-50 -50 100 100" width="1em" height="1em">
...
github: `<svg aria-hidden="true" aria-focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="-50 -50 100 100" width="1em" height="1em">
<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
...
twitter: `<svg aria-hidden="true" aria-focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="-50 -50 100 100" width="1em" height="1em">
  <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
...
const getIcon = (icon, size = 42) => icons[icon] ? icons[icon].replace(/width=".+"\s+height=".+"/, `width="${size}" height="${size}"`) : icons["bug"].replace(/width="\d+"\s+height="\d+"/, `width="${size}" height="${size}"`);

const links = [
  {
    name: 'blog',
    desc: 'Take a look at the articles and verbose syntax of a fledging author'
  },
  {
    name: 'codepen',
    desc: 'Pick and choose from one of the innumerable demos I created to master HTML, CSS, JS, React and much more'
  },
  {
    name: 'freecodecamp',
    desc: 'Admire the certifications I earned learning web development'
  },
  {
    name: 'github',
    desc: 'Check my code, double check my history'
  },
  {
    name: 'twitter',
    ...
    <defs>
      ...
      <mask id="mask-icons">
        ...
        ${links.map((link, index) => `
          <g transform="rotate(${360 / links.length * index}) translate(0 -${Math.floor(size / 3)}) rotate(${360 / links.length * index * -1})">
