...
const illustrationGettingStarted = document.querySelector('article#getting-started > svg');
const illustrationAbout = document.querySelector('article#about > svg');
if (window.IntersectionObserver) {
  ...
  observer.observe(illustrationGettingStarted);
  observer.observe(illustrationAbout);
}